namespace Entity
{
    public class Guerrero : Plantilla
    {
        public Guerrero(int id, string clase, string nombre, int vida, int mana, int fuerza, int defensa, int armaid) : base(id, clase, nombre, vida, mana, fuerza, defensa, armaid)
        {
        }
        public Guerrero() { }
